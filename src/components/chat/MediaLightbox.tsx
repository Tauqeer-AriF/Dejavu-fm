...
export const MediaLightbox: React.FC<MediaLightboxProps> = ({
  ...
  const mediaList = items || mediaItems || [];
  ...
  const handleDownload = () => {
    ...
    link.download = currentItem.title || `chatroom-media-${currentItem.id || Date.now()}`;
    link.target = '_blank';
          ...
          <div className="flex items-center gap-2 sm:gap-3 min-w-0 shrink">
            ...
            <div className="min-w-0">
              <div className="flex items-center gap-1.5 sm:gap-2">
                ...
                >
                  {currentItem.sender || 'Chat Attachment'}
                </span>
          ...
          <div className="relative flex items-center justify-center max-w-full max-h-full">
            {currentItem.type === 'image' ? (
              ...
              >
                <img
                  src={currentItem.url}
                  alt={currentItem.caption || currentItem.title || 'Chat Attachment'}
...
export const StudioMediaLightbox = MediaLightbox;
