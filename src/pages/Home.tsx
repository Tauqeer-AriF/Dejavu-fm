...
export default function Home() {
  ...
  return (
    <motion.div 
      ...
      className="front-page-home flex flex-col space-y-8 md:space-y-12 pb-2 md:pb-4"
    >
      <div 
        className="front-home-hero flex flex-col lg:flex-row items-center justify-center lg:justify-between min-h-[calc(100vh-80px)] lg:min-h-[calc(100vh-270px)] pb-32 lg:pb-0 gap-8 md:gap-12 relative px-4 lg:[--margin-bottom:0px]"
      ...
      >
        ...
        <motion.div 
          ...
          className="relative -mt-10 sm:-mt-14 lg:mt-0 group w-full lg:w-[45%] flex justify-center pt-2 pb-8 sm:py-12 md:py-6 lg:py-12 lg:[--margin-top:0px]"
          style={{ marginTop: 'var(--margin-top, -120px)', paddingTop: '8px' }}
        >
