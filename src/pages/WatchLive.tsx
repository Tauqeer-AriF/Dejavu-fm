        ...
        {isSplitActive && featChat && (
          ...
          >
            ...
            <div className={`flex-1 min-h-0 w-full flex flex-col lg:flex-row transition-colors duration-300 ${isLightMode ? 'bg-[#f4f4f5]' : 'bg-[#030406]'}`}>
              ...
              <div className={`flex-1 min-h-0 w-full lg:w-1/2 lg:shrink-0 border-t lg:border-t-0 lg:border-l flex flex-col transition-colors duration-300 ${isLightMode ? 'border-zinc-200 bg-[#ffffff]' : 'border-zinc-800 bg-[#0b0c10]'}`}>
                <ChatSidebar embedded={true} />
              </div>
            </div>
          </motion.div>
