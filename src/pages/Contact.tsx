  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="glass-panel p-8 rounded-3xl border border-white/5 space-y-6 flex flex-col items-center text-center">
          <div className="w-16 h-16 rounded-2xl bg-neon-purple/20 flex items-center justify-center text-neon-purple shadow-[0_0_20px_rgba(176,38,255,0.2)]">
        ...
        <div className="glass-panel p-8 rounded-3xl border border-white/5 space-y-6 flex flex-col items-center text-center">
          <div className="w-16 h-16 rounded-2xl bg-neon-blue/20 flex items-center justify-center text-neon-blue shadow-[0_0_20px_rgba(38,150,255,0.2)]">
        ...
        <div className="glass-panel p-8 rounded-3xl border border-white/5 space-y-6 flex flex-col items-center text-center">
          <div className="w-16 h-16 rounded-2xl bg-white/10 flex items-center justify-center text-white shadow-[0_0_20px_rgba(255,255,255,0.1)]">
