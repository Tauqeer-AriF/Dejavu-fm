    ...
    <div className="space-y-6">
      ...
      <div className={`p-4 rounded-2xl border space-y-3 transition-colors ${
        ...
        <div className="flex flex-col lg:flex-row items-stretch lg:items-center justify-between gap-3">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 flex-1">
            ...
            {/* Status Filter */}
            <div className={`flex items-center gap-0.5 sm:gap-1 p-1 rounded-xl border overflow-x-auto max-w-full no-scrollbar shrink-0 ${
              ...
              {["ALL", "PENDING_REVIEW", "APPROVED", "REJECTED"].map((st) => (
                <button
                  ...
                  className={`px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-lg text-[11px] sm:text-xs font-bold transition whitespace-nowrap shrink-0 ${
                    statusFilter === st
          ...
          <div className="flex items-center gap-2 shrink-0 self-stretch sm:self-auto justify-end">
            <button
              ...
              className={`px-2.5 sm:px-3 py-1.5 sm:py-2 rounded-xl text-xs font-bold border flex items-center gap-1.5 transition ${
                isLight
            ...
            <select
              ...
              className={`px-2.5 sm:px-3 py-1.5 sm:py-2 rounded-xl text-xs font-bold focus:outline-none focus:border-neon-purple border transition ${
                isLight
            ...
            <div className={`flex items-center gap-1 p-1 rounded-xl border shrink-0 ${
              ...
              {["ALL", "Drop", "Transition", "Banter", "Shoutout", "Exclusive"].map((cat) => (
                <button
                  ...
                  className={`px-2 sm:px-2.5 py-1 rounded-lg text-[11px] sm:text-xs font-medium transition whitespace-nowrap shrink-0 ${
                    categoryFilter === cat
                      ? isLight
      ...
      <AnimatePresence>
        {selectedIds.length > 0 && (
          <motion.div
            ...
            className={`p-3 sm:p-3.5 rounded-2xl border flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2.5 shadow-lg backdrop-blur-md ${
              isLight
          ...
          >
            <div className="flex items-center justify-between sm:justify-start gap-3">
              <button
                ...
                className="flex items-center gap-1.5 text-xs font-bold text-neon-blue hover:underline"
              >
            ...
            <div className="flex items-center gap-1.5 sm:gap-2 flex-wrap sm:flex-nowrap justify-end">
              <button
                ...
                className="px-2.5 sm:px-3 py-1.5 bg-emerald-600 hover:bg-emerald-500 text-white rounded-xl text-[11px] sm:text-xs font-bold flex items-center gap-1.5 transition shadow-sm flex-1 sm:flex-none justify-center"
              >
              ...
              <button
                ...
                disabled={isBatchProcessing}
                className="px-2.5 sm:px-3 py-1.5 bg-neon-purple hover:bg-neon-purple/90 text-white rounded-xl text-[11px] sm:text-xs font-bold flex items-center gap-1.5 transition shadow-sm flex-1 sm:flex-none justify-center"
              >
              ...
              <button
                ...
                disabled={isBatchProcessing}
                className="px-2.5 sm:px-3 py-1.5 bg-rose-600/80 hover:bg-rose-600 text-white rounded-xl text-[11px] sm:text-xs font-bold flex items-center gap-1.5 transition shadow-sm flex-1 sm:flex-none justify-center"
              >
      ...
      {filteredReels.length === 0 ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-6 items-start">
          ...
          <div className="lg:col-span-5 space-y-3 max-h-[45vh] lg:max-h-[85vh] overflow-y-auto pr-1">
          ...
          {selectedReel && (
            <div className="lg:col-span-7 space-y-4 sm:space-y-6">
              {/* Top Inspector Card */}
              <div className={`p-4 sm:p-6 rounded-3xl border space-y-4 sm:space-y-6 transition-colors ${
                isLight
