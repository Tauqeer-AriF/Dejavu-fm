  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-md overflow-y-auto">
      <motion.div
        ...
        className={`w-full max-w-2xl rounded-3xl border p-6 md:p-8 space-y-6 max-h-[90vh] overflow-y-auto shadow-2xl relative my-8 transition-colors ${
          isLight
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className={`text-xs font-mono ${isLight ? "text-slate-500" : "text-white/50"}`}>
                Analyze DJ shows, detect viral moments & generate 9:16 clips
              </p>
            </div>
          </div>
          <button
